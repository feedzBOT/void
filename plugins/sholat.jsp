...
let handler = async(m, { conn, text }) => {
  ...
  await m.reply('Searching...')
	axios.get(`https://api.zeks.xyz/api/jadwalsholat?apikey=Ze3af6X1SjJeUebhHUZCsHMeH13&daerah=${text}`).then ((res) => {
    ...
    awaconn.send2Button(hasil, 'Created By Sakura さくら', 'YA ALLAH', '.', 'SHOLLAT YA', '.', { quoted: m })
}
